//
//  NestsEvaluateBIZViewController.m
//  Nests
//
...
@interface NestsEvaluateBIZViewController () <UITableViewDataSource, UITableViewDelegate,StarRatingDelegate,TextFieldCellDelegate>
...
@implementation NestsEvaluateBIZViewController
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView
{
    ...
    NSInteger sections =[[self.dataSource arraytableRepresentationEdit:_infoDataDic]  count];
    return sections;
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)sectionIndex
{
    ...
    if (sectionIndex<[[self.dataSource arraytableRepresentationEdit:_infoDataDic]  count]) {
        NSDictionary* infoDic=[[self.dataSource arraytableRepresentationEdit:_infoDataDic] objectAtIndex:sectionIndex];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSInteger section =indexPath.section;
     ...
     NSDictionary* indexDic=[[self.dataSource arraytableRepresentationEdit:_infoDataDic] objectAtIndex:section];
...
{
    __weak NestsEvaluateBIZViewController *weakSelf = self;
...
#pragma mark-Network
-(void)netMerEvaluateID:(NSString*)consumeId
                  score:(float)score
                content:(NSString*)content
{
    ...
    [self.networkClient netMerEvaluateID:NET_MER_EVALUATE_ID consumeId:consumeId score:[NSNumber numberWithFloat:score] content:content delegate:self
                               didFinish:@selector(didNetMerEvaluateIDFinish:userInfo:)
...
- (void)didNetMerEvaluateIDFinish:(id)result userInfo:(NSDictionary *)userInfo {
    
    [SVProgressHUD dismiss];
    NSDictionary* resultDic =[result stringJsonValue];
    DDDebug(@"评价商家请求成功＝＝＝%@",resultDic);
