//
//  NestsResideMenuSecondViewController.m
//  RESideMenuExample
//
...
@implementation NestsResideMenuSecondViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    NSLog(@"NestsResideMenuSecondViewController will appear");
}

- (void)viewWillDisappear:(BOOL)animated
{
    [super viewWillDisappear:animated];
    NSLog(@"NestsResideMenuSecondViewController will disappear");
}
