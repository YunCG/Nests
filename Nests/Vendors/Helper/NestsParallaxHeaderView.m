...
@interface NestsParallaxHeaderView ()
...
@implementation NestsParallaxHeaderView

+ (id)parallaxHeaderViewWithImage:(UIImage *)image forSize:(CGSize)headerSize;
{
    NestsParallaxHeaderView *headerView = [[NestsParallaxHeaderView alloc] initWithFrame:CGRectMake(0, 0, headerSize.width, headerSize.height)];
...
{
    NestsParallaxHeaderView *headerView = [[NestsParallaxHeaderView alloc] initWithFrame:CGRectMake(0, 0, subView.frame.size.width, subView.frame.size.height)];
